...
output_name = f"{script_args.log_dir}/{model_name_split}_grm_len{script_args.max_length}_fulltrain_{script_args.learning_rate}_data{script_args.dataset.split('/')[-1]}"
